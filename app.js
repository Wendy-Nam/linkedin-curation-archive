      ...
      <section class="home">
        <div class="home-hero">
          ...
          <div class="home-actions">
            ...
            ${profile.github ? `<a class="hbtn" href="${esc(profile.github)}" target="_blank" rel="noopener noreferrer">GitHub${EXT}</a>` : ""}
            ${(isEn() && profile.medium) ? `<a class="hbtn" href="${esc(profile.medium)}" target="_blank" rel="noopener noreferrer">Medium${EXT}</a>` : ""}
